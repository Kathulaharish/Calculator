...
function Calculator() {
  ...
  const [answer, setAnswer] = useState("");
    // input--> this state variable initialized with an empty string. It is typically used to store user input
    // setInput--> is function used to change the input value when you needed
    // Similarly answer and setAnswer
